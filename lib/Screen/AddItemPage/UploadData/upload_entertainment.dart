...
class UploadEntertainment extends StatefulWidget {
  @override
  _UploadEntertainmentState createState() => _UploadEntertainmentState();
}

class _UploadEntertainmentState extends State<UploadEntertainment> {
  ...
  Future<String> uploadItemImage(file) async {
    final StorageReference storageReference =
        FirebaseStorage.instance.ref().child("entertainment");
  ...
  saveItem(imageDownloadUrl) {
    ...
    final itemsRef = FirebaseFirestore.instance.collection('Entertainment');
