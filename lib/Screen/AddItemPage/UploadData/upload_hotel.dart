...
class UploadHotel extends StatefulWidget {
  @override
  _UploadHotelState createState() => _UploadHotelState();
}

class _UploadHotelState extends State<UploadHotel> {
  ...
  saveItem(imageDownloadUrl) {
    ...
    final itemsRef = FirebaseFirestore.instance.collection('Hotels');
