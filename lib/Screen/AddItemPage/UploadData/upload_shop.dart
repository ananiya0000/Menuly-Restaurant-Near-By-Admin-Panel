...
class UploadShop extends StatefulWidget {
  @override
  _UploadShopState createState() => _UploadShopState();
}

class _UploadShopState extends State<UploadShop> {
  ...
  saveItem(imageDownloadUrl) {
    ...
    final itemsRef = FirebaseFirestore.instance.collection('Shopping');
